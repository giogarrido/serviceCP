...
const Estado = sequelize.define("estados", { // Define the "estados" table
    id_estado: {
...
const Ciudad = sequelize.define("ciudades", { // Define the "ciudades" table
    id_ciudad: {
        type: DataTypes.INTEGER,
        primaryKey: true,
        autoIncrement: true,
...
const Colonia = sequelize.define("colonias", { // Define the "colonias" table
    id_colonia: {
        type: DataTypes.INTEGER,
        primaryKey: true,
        autoIncrement: true,
